...
func (c *shard) Set(id uint64, fileNum base.FileNum, offset uint64, value *Value, eligibleForSecondary bool) Handle {
	if n := value.refs(); n != 1 {
...
func (c *Cache) Set(id uint64, fileNum base.FileNum, offset uint64, value *Value, eligibleForSecondary bool) Handle {
